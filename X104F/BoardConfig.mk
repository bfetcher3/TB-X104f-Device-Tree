...
# Assert
TARGET_OTA_ASSERT_DEVICE := X104F

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 13137196 # This is the maximum known partition size, but it can be higher, so we just omit it
